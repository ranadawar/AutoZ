...
export const icons = {
  ...
  dollar: require("../../assets/icons/purchases.png"),
  card: require("../../assets/icons/card.png"),
  heart: require("../../assets/icons/heart.png"),
  bellc: require("../../assets/icons/bellc.png"),
  setting: require("../../assets/icons/setting.png"),
  profilec: require("../../assets/icons/profilec.png"),
  promote: require("../../assets/icons/promote.png"),
  link: require("../../assets/icons/link.png"),
  heartc: require("../../assets/icons/heartc.png"),
  profilep: require("../../assets/icons/profilep.png"),
  chevron: require("../../assets/icons/productBack.png"),
  enter: require("../../assets/icons/enter.png"),
  redHeart: require("../../assets/icons/redheart.png"),
  ship: require("../../assets/icons/shipIcon.png"),
  star: require("../../assets/icons/star.png"),
  partNumber: require("../../assets/icons/partnumber.png"),
  brand: require("../../assets/icons/brand.png"),
  car: require("../../assets/icons/car.png"),
  camera: require("../../assets/icons/camera.png"),
  gallery: require("../../assets/icons/gallery.png"),
  postc: require("../../assets/icons/postc.png"),
};
...
export const images = {
  ...
  chain: require("../../assets/images/chainsaw.png"),
};
